...
data_bebold_n6 = {'name': r'bebold_n6', 
                     'color': color[5],
                     'logdirs': ['/mnt/brain7/scratch/roihn/NovelD/experiments/MiniGrid-MultiRoom-N6-v0-bebold-20220503-022103/logs.csv',],
                     'load_func': load_csv_data_bebold,
                    }
data_bebold_n7s8 = {'name': r'bebold_n7s8', 
                     'color': color[6],
                     'logdirs': ['/mnt/brain7/scratch/roihn/NovelD/experiments/MiniGrid-MultiRoom-N7-S8-v0-bebold-20220503-022133/logs.csv',],
                     'load_func': load_csv_data_bebold,
                    }

DATA = [data_bebold_n6s10, data_bebold_n7s4, data_bebold_n6, data_bebold_n7s8]
